...
下载地址：
**[⚡️点我下载最新版本](https://github.com/huiyadanli/RevokeMsgPatcher/releases/download/1.4/RevokeMsgPatcher.v1.4.fix2.zip)** |
[☁备用下载-蓝奏云](https://wwn.lanzouf.com/i62dL04v74na) | 
[☁备用下载-百度云](https://pan.baidu.com/s/1r-GC0Z5ZGBoJArNLnDrSdg?pwd=ud3s) 
